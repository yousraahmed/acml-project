...
export default class hr extends Component {
    ...
    handleChangeCapacity(evt) {
     ...
     onSubmit(e) {
        ...
        axios.put('/hr/locationAffairs', loc)
    ...
    render() {
        return (
          ...
          <label>Location to be updated: </label>
          <input  type="text"
              required
              ...
              />
                 ...
                 <div className="form-group"> 
          <label>Type(if you will not update enter the old one): </label>
          <input  type="text"
              required
              className="form-control"
        ...
        <div className="form-group"> 
          <label>Capacity(if you will not update enter the old one): </label>
          <input  type="text"
              required
              className="form-control"
