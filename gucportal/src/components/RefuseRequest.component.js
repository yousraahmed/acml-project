...
export default class acceptReq extends Component{
  ...
  onSubmit(e){
    ...
    console.log(ref);
    axios.put('/coordinator/SLreq', ref,{headers:{'auth-token':localStorage.getItem('auth-token')}})
        ...
        return (
          ...
          <input  type="text"
              ...
              />
                ...
                <div className="form-group">
               <input type="submit" value="Refuse" className="btn btn-primary" />
               </div>
                </form>
