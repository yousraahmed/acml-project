...
export default class TeachingAssignments extends Component{
    ...
    handleClick(e)
    {
        ...
        axios.post('http://localhost:5000/teachingAssignments', slot,  {headers: {'auth-token':localStorage.getItem('auth-token')}})
    ...
    render() {
        ...
        return( 
            ...
            <button onClick={this.handleClick} type="submit" className="btn btn-primary">View Assignments</button>
          ...
          <div>
                 ...
                 <div>
                 <h4>staffID: {text.staffID}</h4>
                 <p>courseName : {text.courseName}</p>
                 <p>slotTime: {text.slotTime}</p>
                 <p>.</p>
