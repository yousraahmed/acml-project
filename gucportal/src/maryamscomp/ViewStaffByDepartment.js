...
export default class ViewStaffByDepartment extends Component{
    ...
    handleClick(e)
    {
        ...
        axios.post('http://localhost:5000/viewStaffByDepartment', hod,  {headers: {'auth-token':localStorage.getItem('auth-token')}})
        .then((res) => { 
