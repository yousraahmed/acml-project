...
export default class LeaveRequests extends Component{
    ...
    handleClick(e)
    {
        ...
        axios.post('http://localhost:5000/requestsLeave', hod,  {headers: {'auth-token':localStorage.getItem('auth-token')}})
    ...
    render() {
        ...
        return( 
            ...
            <button onClick={this.handleClick} type="submit" className="btn btn-primary">View Leave Requests</button>
