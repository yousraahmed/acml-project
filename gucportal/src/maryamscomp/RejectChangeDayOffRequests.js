...
export default class RejectChangeDayOffRequests extends Component{
    ...
    handleClick(event)
    {
        ...
        axios.post('http://localhost:5000/rejectChangeDayOffRequests', request,  {headers: {'auth-token':localStorage.getItem('auth-token')}})
    ...
    render()
    {
        return(
            ...
            <button onClick={this.handleClick} type="submit" className="btn btn-primary">Reject Request</button>
          </form>
